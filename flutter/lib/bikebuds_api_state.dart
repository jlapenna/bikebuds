...
class BikebudsApiState with ChangeNotifier {
  ...
  _onFirebaseStateChanged() async {
    print('$this: _onFirebaseStateChanged: $_firebaseState');
    ...
    if (_firebaseState.user != null) {
      try {
        ...
        print("$this: _onFirebaseStateChanged failed: $err: $stack");
      }
    }
    notifyListeners();
  }
