...
export default class Privacy extends Component {
  render() {
    return (
      <div>
        <h1>bikebuds.cc - Privacy Policy</h1>
        <p>Last Updated: 2019/02/13</p>
        <p>
          Our privacy policy applies to information we collect when you use or
          access our website located at &nbsp;
          <a href="https://bikebuds.cc">https://bikebuds.cc</a>&nbsp; use the
          bikebuds.cc, social networking services, or just interact with us. We
          may change this privacy policy from time to time. Whenever we make
          changes to this privacy policy, the changes are effective one month
          after we post the revised privacy policy to our website (as indicated
          by revising the date at the top of our privacy policy). We encourage
          you to review our privacy policy whenever you access our services to
        ...
        <ul>
          ...
          <li>
            Device Information: We collect information about the computer you
            use to access our services, including the hardware model, and
          ...
          <li>
            ...
            files stored on your hard drive or in your device memory that helps
            us to improve our services and your experience, see which areas and
            features of our services are popular and count visits. We may also
            collect information using web beacons (also known as &quot;tracking
            pixels&quot;). Web beacons are electronic images that may be used in
            our services or emails and to track count visits or understand usage
            and campaign effectiveness. For more information about cookies, and
            how to disable them, please see &quot;Your Information Choices&quot;
            below.
          </li>
        </ul>
        ...
        <p>
          ...
          with better service in general, we may combine information obtained
          from other sources (for example, a third-party developer whose
          application you have authorized) and combine that with information we
          collect through our services.
        </p>
        <h3>Services We Collect Data From (non-exhaustive)</h3>
        <ul>
          <li>Strav a</li>
          <li>Withings</li>
          <li>Fitbit</li>
        ...
        <p>We do not use your information for serving ads.</p>
        <p>We use information about you for various purposes, including to:</p>
        <ul>
          <li>Provide ride planning features;</li>
          <li>Provide health and fitness analysis and monitoring;</li>
          <li>Provide, maintain and improve our services;</li>
          <li>
            Provide services you request, process transactions and to send you
          ...
          <li>
            Communicate with you about bikebuds.cc-related news and information;
          </li>
          <li>
        ...
        <p>
          ...
          transfer of your information in and to the United States and other
          countries.
        </p>
        ...
        <ul>
          <li>
            With third party vendors and other service providers who need access
            to your information to carry out work on our behalf.
          </li>
          <li>
          ...
          <li>
            ...
            <a href="https://bikebuds.cc/tos">Terms of Service</a>; and to
            protect bikebuds.cc, our users or the public from harm or illegal
            activities;
          </li>
          <li>
        ...
        <p>
          ...
          be used by bikebuds.cc and third parties to, among other things,
          analyze and track data, determine the popularity of certain content
          and other websites and better understand your online activity. Our
          privacy policy does not apply to, and we are not responsible for,
          third party cookies, web beacons or other tracking technologies and we
          encourage you to check the privacy policies of these third parties to
          learn more about their privacy practices.
        </p>
        <h3>Third Party Analytics Services We Use (non-exhaustive)</h3>
        <ul>
        ...
        <h2>Security</h2>
        <p>
          bikebuds.cc &nbsp;takes reasonable measures to help protect personal
        ...
        <p>
          ...
          logging into your online account and modifying your personal profile.
          If you wish to delete or suspend your account, please email us at
          <a href="mailto:bikebuds-support@googlegroups.com">
            bikebuds-support@googlegroups.com
          </a>
          ...
          archived copies of your information for a certain period of time. In
          any case, deleted content will not remain in our system or backups for
        ...
        <p>
          You may opt out of receiving promotional emails from bikebuds.cc by
