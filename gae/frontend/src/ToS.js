...
export default class ToS extends Component {
  render() {
    return (
      <div>
        <h1>bikebuds.cc - Terms of Service </h1>
        <p>Last Updated: 2019/02/13</p>
        <p>
          <span>
            These terms of service (&quot;Terms&quot;) apply to your access and
            use of bikebuds.cc (the &quot;Service&quot;). Please read them
            carefully.
          </span>
        </p>
        <h2>
          <span>Accepting these Terms</span>
        </h2>
        <p>
          <span>
        ...
        <p>
          <span>
            ...
            one month after we post such revised Terms (indicated by revising
            ...
            It is your responsibility to check bikebuds.cc for changes to these
            Terms.
          </span>
        </p>
        <p>
        ...
        <p>
          ...
          <span>
            <a href="https://bikebuds.cc/privacy">
              https://bikebuds.cc/privacy
            </a>
          </span>
          <span>.</span>
        </p>
        ...
        <h2>
          <span>Your Content &amp; Conduct</span>
        </h2>
        <p>
          <span>
        ...
        <p>
          <span>
            ...
            of 35 days and then delete them.
          </span>
        </p>
        <p>
          <span>
        ...
        <h2>
          <span>bikebuds.cc Materials</span>
        </h2>
        <p>
          <span>
        ...
        <h2>
          <span>Hyperlinks and Third Party Content</span>
        </h2>
        <p>
          <span>
        ...
        <p>
          <span>
            bikebuds.cc makes no claim or representation regarding, and accepts
            no responsibility for third party websites accessible by hyperlink
            from the Service or websites linking to the Service. When you leave
            the Service, you should be aware that these Terms and our policies
            no longer govern.
          </span>
        </p>
        <p>
        ...
        <h2>
          <span>Unavoidable Legal Stuff</span>
        </h2>
        <p>
          <span>
        ...
        <p>
          <span>
            IN NO EVENT WILL bikebuds.cc BE LIABLE TO YOU OR ANY THIRD PARTY FOR
            ...
            OR ANY OTHER SERVICE AND/OR CONTENT INCLUDED ON OR OTHERWISE MADE
            ...
            FOR ALL CAUSES OF ACTION AND UNDER ALL THEORIES OF LIABILITY WILL BE
            LIMITED TO THE AMOUNT YOU PAID TO bikebuds.cc. THIS SECTION WILL BE
            GIVEN FULL EFFECT EVEN IF ANY REMEDY SPECIFIED IN THIS AGREEMENT IS
        ...
        <p>
          <span>
            ...
            determined under and in accordance with the laws of the California,
        ...
        <p>
          <span>
            ...
            the California and you further agree and expressly consent to the
            exercise of personal jurisdiction in the courts of the California
            located in San Francisco, CA in connection with any such dispute
            including any claim involving Service. You further agree that you
            and Service will not commence against the other a class action,
        ...
        <p>
          <span>
            ...
            bikebuds.cc regarding the use of the Service, superseding any prior
            agreements between you and bikebuds.cc relating to your use of the
            Service.
          </span>
        </p>
        <h2>
        ...
        <p>
          <span>
            ...
            in general, bikebuds.cc. When you provide us with any feedback,
            comments or suggestions about the Service, these Terms and, in
            general, bikebuds.cc, you irrevocably assign to us all of your
